...
const Card: React.FC<CardProps> = ({ href, imgSrc, layoutId }) => {
  return (
    <Link href={href}>
      <div className="relative h-20 md:h40 bg-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition">
...
export default function Home() {
  return (
    <div>
      ...
      <div className="mt-10 md:mt-24 grid w-full grid-cols-1 grid-rows-3 gap-4 md:grid-cols-3 mdgrid-rows-1">
